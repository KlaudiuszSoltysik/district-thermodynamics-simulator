...
class MPC:
    ...
    def cost_function(
        ...
        for k in range(horizon_steps):
            ...
            co2_generation_m3_s = (self.CO2_GENERATION_M3_H_PER_PERSON / 3600.0) * is_enabled_forecast[k]
            ...
            below_min = np.maximum(0, T_horizon[k] - self.TEMPERATURE_TOLERANCE - T_sim)
            above_max = np.maximum(0, T_sim - T_horizon[k] + self.TEMPERATURE_TOLERANCE)
            total_penalty += (
